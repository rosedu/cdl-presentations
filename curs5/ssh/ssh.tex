...
\begin{frame}{Folosire ssh-agent}
  \begin{itemize}
    \item mai multe perechi de chei -> folosire opțiune -i la ssh/scp
    \item chei cu passphrase -> introducerea passphrase-ului la fiecare
conectare
    ...
    \item la autentiface nu se mai cere passphrase; nu mai e nevoie de -i
    \item pornit automat cu interfața grafică
    \item \href{http://www.gentoo.org/proj/en/keychain/}
  \end{itemize}
\end{frame}
