...
\pgfdeclareimage[height=8cm]{online}{img/online}
\pgfdeclareimage[height=6cm]{fork}{img/fork}
\pgfdeclareimage[height=6cm]{clone}{img/clone}
\pgfdeclareimage[height=6cm]{repo}{img/repo}
\pgfdeclareimage[height=6cm]{add}{img/add}
\pgfdeclareimage[height=6cm]{commit}{img/commit}
\pgfdeclareimage[height=6cm]{push}{img/push}
\pgfdeclareimage[height=6cm]{pr}{img/pr}
