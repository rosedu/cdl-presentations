...
\begin{frame}
  \frametitle{diff (fără parametri)}
...
\begin{frame}
  \frametitle{diff (fără parametri)}
  \begin{itemize}
    \item ``\textless'' în fața liniilor șterse din fișierul original
    \item ``\textgreater'' în fața liniilor adăugate în fișierul modificat
  \end{itemize}
\end{frame}
