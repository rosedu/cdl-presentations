    ...
    \item o serie de blocuri:
      \begin{itemize}
        \item bloc (cu context) care arată liniile din fișierul originalv
          ...
          \end{itemize}
        \item `` '' în fața liniilor \textit{nemodificate} (context)
  ...
  \item antet: cui îi corespund liniile din blocul cu ``+++'' sau ``{-}{-}{-}''
    \item o serie de blocuri:
      ...
      \item bloc (cu context) care arată liniile din fișierul originalv
        ...
        \item {-}{-}{-} startModif, stopModif {-}{-}{-}
        \end{itemize}
      \item `` '' în fața liniilor nemodificate (context)
      \item ``-'' în fața liniilor modificate din fișierul original
      \item ``+'' în fața liniilor modificate din fișierul modificat
      \end{itemize}
  \end{itemize}
\end{frame}
